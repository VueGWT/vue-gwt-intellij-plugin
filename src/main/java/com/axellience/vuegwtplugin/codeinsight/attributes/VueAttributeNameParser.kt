...
import com.axellience.vuegwtplugin.codeinsight.*
import com.axellience.vuegwtplugin.model.DEPRECATED_SLOT_ATTRIBUTE
import com.axellience.vuegwtplugin.model.SLOT_NAME_ATTRIBUTE
...
const val TEMPLATE_TAG_NAME = "template"
const val SLOT_TAG_NAME = "slot"
    ...
    companion object {
        ...
        private fun parse(attributeName: String, isValid: (VueAttributeKind) -> Boolean): VueAttributeInfo {
            ...
            if (attributeName.startsWith(ATTR_EVENT_SHORTHAND)) {
                ...
                val attributeKind = attributeKindMap.get(name).find(isValid)
