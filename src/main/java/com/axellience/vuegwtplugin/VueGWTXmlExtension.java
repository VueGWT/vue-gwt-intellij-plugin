...
import com.axellience.vuegwtplugin.language.VueGWTLanguage;
...
import static com.axellience.vuegwtplugin.VueGWTPluginUtil.COMPONENT_ANNOTATION_NAME;
...
public class VueGWTXmlExtension extends HtmlXmlExtension
{
    ...
    {
        return psiFile.getLanguage() == VueGWTLanguage.INSTANCE;
    }
    ...
    public TagNameReference createTagNameReference(ASTNode astNode, boolean b)
    {
        ...
        for (PsiClass psiClass : psiJavaFile.getClasses())
        {
            PsiAnnotation componentAnnotation =
                PsiTypesUtil.getClassType(psiClass).findAnnotation(COMPONENT_ANNOTATION_NAME);
